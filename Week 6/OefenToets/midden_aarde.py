...
def lees_helden_uit_bestand():
    ...
    bestand = open("helden.txt", "r")
    Legolas = {"Naam":"Legolas"}, \
                  {"kracht":"7"},\
                  {"verdediging":"5"},\
                  {"aanvallen":"2"},\
                  {"beschrijving":"Legolas zoon van Thranduil uit Mirkwood"}

    Gimli =   {"Naam":"Gimli"}, \
                  {"kracht":"5"},\
                  {"verdediging":"8"},\
                  {"aanvallen":"3"},\
                  {"beschrijving":"Gimli zoon van Glion uit de Lonly Mountain"}
